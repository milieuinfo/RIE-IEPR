...
// URI template: https://data.riepr.omgeving.vlaanderen.be/id/contactpersoon/{uuid}/{issued}/{modified}
...
import type { IAxente } from './Axente.interface';
...
export class Contactpersoon {
  ...
  @jsonMember(Object, { name: 'http://www.w3.org/ns/org#memberOf' })
  exploitant!: IAxente;

  @jsonMember(String, { name: 'http://www.w3.org/2000/01/rdf-schema#label' })
  benaming!: string;

  @jsonMember(String, { name: 'http://xmlns.com/foaf/0.1/mbox' })
  email?: string;

  @jsonMember(String, { name: 'http://xmlns.com/foaf/0.1/phone' })
  telefoonnummer?: string;

  @jsonMember(String, { name: 'http://www.w3.org/ns/org#hasRole' })
  hasRole!: string;

  @jsonMember(Adres, { name: 'http://www.w3.org/ns/locn#address' })
  adres?: Adres;
  ...
  @jsonMember(String, { name: 'http://xmlns.com/foaf/0.1/name' })
  name!: string;
  ...
  generateUri(): string | undefined {
    ...
    let uri = 'https://data.riepr.omgeving.vlaanderen.be/id/contactpersoon/{uuid}/{issued}/{modified}';
    let uuid = '' as any;
    try {
