...
emissiepunt1.locatie = hoofdZetel.uri;
...
emissiepunt2.locatie = hoofdZetel.uri;
...
emissiepunt3.locatie = hoofdZetel.uri;
...
emissiepunt4.locatie = hoofdZetel.uri;
...
emissiepunt5.locatie = hoofdZetel.uri;
...
apparaat1.locatie = hoofdZetel.uri;
...
apparaat2.locatie = hoofdZetel.uri;
...
installatie1.locatie = hoofdZetel.uri;
...
installatie2.locatie = hoofdZetel.uri;
...
procesHoofd.locatie = hoofdZetel.uri;
procesHoofd.hasInputVar = [ijzererts.uri];
procesHoofd.hasOutputVar = [staalplaat.uri];
...
proces1.locatie = hoofdZetel.uri;
proces1.hasInputVar = [ijzererts.uri];
proces1.hasOutputVar = ['https://data.riepr.omgeving.vlaanderen.be/id/stof/grondstoffen_mix'];
proces1.onderdeelVan = procesHoofd.uri;
