...
// URI template: https://data.riepr.omgeving.vlaanderen.be/id/meetpunt/{uuid}/{issued}/{modified}
...
@jsonObject
export class Meetpunt implements ISysteem {
  ...
  @jsonMember(String, { name: 'http://www.opengis.net/ont/geosparql#hasGeometry' })
  geometrie?: string;

  @jsonArrayMember(MeetpuntIdentifier, { name: 'http://www.w3.org/ns/adms#identifier' })
  ...
  generateUri(): string | undefined {
    ...
    let uri = 'https://data.riepr.omgeving.vlaanderen.be/id/meetpunt/{uuid}/{issued}/{modified}';
    let uuid = '' as any;
    try {
