...
// URI template: https://data.riepr.omgeving.vlaanderen.be/id/onttrekkingspunt/{uuid}/{issued}/{modified}
...
@jsonObject
export class Onttrekkingspunt implements ISysteem {
  ...
  generateUri(): string | undefined {
    ...
    let uri = 'https://data.riepr.omgeving.vlaanderen.be/id/onttrekkingspunt/{uuid}/{issued}/{modified}';
    let uuid = '' as any;
    try {
