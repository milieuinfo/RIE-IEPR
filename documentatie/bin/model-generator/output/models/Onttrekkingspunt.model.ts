...
// URI template: https://data.riepr.omgeving.vlaanderen.be/id/onttrekkingspunt/{id}
...
@jsonObject
export class Onttrekkingspunt implements IAgent {
  ...
  generateUri(): string | undefined {
    ...
    let uri = 'https://data.riepr.omgeving.vlaanderen.be/id/onttrekkingspunt/{id}';
    let id = '' as any;
    try {
