...
// URI template: https://data.riepr.omgeving.vlaanderen.be/id/installatie/{id}
...
export class Installatie implements ISystem {
  ...
  @jsonArrayMember(Object, { name: 'implements' })
  implementeert?: IAgent[];
  ...
  generateUri(): string | undefined {
    ...
    let uri = 'https://data.riepr.omgeving.vlaanderen.be/id/installatie/{id}';
    let id = '' as any;
    try {
