...
// URI template: https://data.riepr.omgeving.vlaanderen.be/id/apparaat/{uuid}/{issued}/{modified}
...
@jsonObject
export class Apparaat implements ISysteem {
  ...
  generateUri(): string | undefined {
    ...
    let uri = 'https://data.riepr.omgeving.vlaanderen.be/id/apparaat/{uuid}/{issued}/{modified}';
    let uuid = '' as any;
    try {
