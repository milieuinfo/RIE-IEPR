...
// URI template: https://data.riepr.omgeving.vlaanderen.be/id/emissiepunt/{uuid}/{issued}/{modified}
...
@jsonObject
export class Emissiepunt implements ISysteem {
  ...
  generateUri(): string | undefined {
    ...
    let uri = 'https://data.riepr.omgeving.vlaanderen.be/id/emissiepunt/{uuid}/{issued}/{modified}';
    let uuid = '' as any;
    try {
