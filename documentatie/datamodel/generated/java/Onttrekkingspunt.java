...
/**
 * Onttrekkingspunt
 * <a href="https://data.riepr.omgeving.vlaanderen.be/ns/riepr#Onttrekkingspunt">Onttrekkingspunt</a>
 **/
@Getter
@Setter
@Entity(name = "Onttrekkingspunt")
...
public class Onttrekkingspunt implements ISysteem {
	...
	@ManyToMany
	@JoinTable(
		name = "onttrekkingspunt_externe_identificator",
	...
	@ManyToMany
	@JoinTable(
		name = "onttrekkingspunt_systeemeigenschap",
		joinColumns = @JoinColumn(name = "source_uuid"),
		inverseJoinColumns = @JoinColumn(name = "target_uuid")
	)
