...
/**
 * Uitwisseling
 * <a href="https://data.riepr.omgeving.vlaanderen.be/ns/riepr#Uitwisseling">Uitwisseling</a>
 **/
@Getter
@Setter
@Entity(name = "Uitwisseling")
@Builder(toBuilder = true)
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "uitwisseling")
public class Uitwisseling implements IGebeurtenis {
