...
/**
 * OnttrekkingObservatie
 * <a href="https://data.riepr.omgeving.vlaanderen.be/ns/riepr#OnttrekkingObservatie">OnttrekkingObservatie</a>
 **/
@Getter
@Setter
@Entity(name = "OnttrekkingObservatie")
@Builder(toBuilder = true)
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "onttrekking_observatie")
public class OnttrekkingObservatie implements IObservation {
	...
	private Onttrekking heeftAandachtspunt;
