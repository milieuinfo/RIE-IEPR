...
/**
 * Emissiepunt
 * <a href="https://data.riepr.omgeving.vlaanderen.be/ns/riepr#Emissiepunt">Emissiepunt</a>
 **/
@Getter
@Setter
@Entity(name = "Emissiepunt")
...
public class Emissiepunt implements ISysteem {
	...
	@ManyToMany
	@JoinTable(
		name = "rel_emissiepunt_externe_identificator",
	...
	@ManyToMany
	@JoinTable(
		name = "rel_emissiepunt_systeem_eigenschap",
		joinColumns = @JoinColumn(name = "source_uuid"),
		inverseJoinColumns = @JoinColumn(name = "target_uuid")
	)
