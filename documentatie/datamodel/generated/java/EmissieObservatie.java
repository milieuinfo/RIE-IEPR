...
/**
 * EmissieObservatie
 * <a href="https://data.riepr.omgeving.vlaanderen.be/ns/riepr#EmissieObservatie">EmissieObservatie</a>
 **/
@Getter
@Setter
@Entity(name = "EmissieObservatie")
@Builder(toBuilder = true)
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "emissie_observatie")
public class EmissieObservatie implements IObservation {
	...
	private Emissie heeftAandachtspunt;
