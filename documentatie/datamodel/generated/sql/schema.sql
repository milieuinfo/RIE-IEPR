...
-- Ontology: null
-- Generated: 2026-09-14T11:20:01.125246347Z[GMT]
...
ALTER TABLE filter_systeemeigenschap ADD FOREIGN KEY (filter_id) REFERENCES filter_identity(systeem_uuid);
...
ALTER TABLE proces ADD FOREIGN KEY (systeem) REFERENCES exploitatie(uuid);
