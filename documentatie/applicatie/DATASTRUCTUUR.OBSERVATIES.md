...
> DIT DOCUMENT IS EEN WORK IN PROGRESS
...
In sommige gevallen moeten we echter op de installatie rapporteren, in dat geval kunnen we simpelweg het proces (VERWERKING) gebruiken. Op deze manier hebben
we een enkele entiteit waarop we moeten rapporteren.
